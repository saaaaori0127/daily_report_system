...
<c:set var="comUpd" value="${ForwardConst.CMD_UPDATE.getValue()}" />
<c:set var="connDel" value="${ForwardConst.CMD_DESTROY.getValue()}" />
...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <form method="POST"
            action="<c:url value='?action=${action}&command=${connUpd}'/>">
            <c:import url="_form.jsp" />
        </form>

        <p>
            <a href="#" onclick="congirmDestroy();">この従業員情報を削除する</a>
        </p>
        <form method="POST"
